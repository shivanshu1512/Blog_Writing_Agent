...
# -----------------------------
# 4) Research (DuckDuckGo — 100% FREE, NO API KEY NEEDED)
# -----------------------------
def _tavily_search(query: str, max_results: int = 5) -> List[dict]:
    """Web search using DuckDuckGo — completely free, no API key required.
    Install dependency: pip install duckduckgo-search
    Function name kept as _tavily_search for backward compatibility.
    """
    try:
